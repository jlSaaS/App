  ...
  <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" enter-to="opacity-100 translate-y-0 sm:scale-100" leave="ease-in duration-200" leave-from="opacity-100 translate-y-0 sm:scale-100" leave-to="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95">
    <div class="inline-block align-bottom bg-white rounded-lg px-4 py-5 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-xl sm:w-full sm:p-6">
      <div class="text-left">
        ...
        <div class="mt-2">
          <p class="text-sm text-gray-500">
            Just send us the state name and the exam notice and documents.
          </p>
          <p class="text-sm text-gray-500">
      ...
      <div class="mt-4 text-left">
        <div class="">
          ...
          <div class="mt-1 sm:col-span-2">
            <select v-model="newExam.state" id="state" name="state" class="block focus:ring-primary focus:border-primary w-full shadow-sm sm:text-sm border-gray-300 rounded-md" :class="{ 'bg-gray-100 text-gray-400' : !newExam.state }">
      ...
      <div class="mt-10 flex">
        <button type="button" class="inline-flex justify-center w-full rounded-md border border-transparent shadow-sm px-4 py-2 bg-primary text-base font-medium text-white hover:bg-primary hover:bg-opacity-90 focus:outline-none sm:w-auto sm:text-sm mr-3" @click="save()">
          Send Info
        </button>
        <button type="button" class="inline-flex justify-center w-full rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none sm:w-auto sm:text-sm" @click="close(null)" ref="cancelButtonRef">
          Don't Send Info
        </button>
      </div>
    </div>
