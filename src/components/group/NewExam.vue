    ...
    <div class="inline-block align-bottom bg-white rounded-lg px-4 py-5 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-xl sm:w-full sm:p-6">
      ...
      <div class="mt-4 text-left">
        ...
        <div
          ...
          :class="{ 'bg-red-100 border-red-500': dragging && !dropzoneStatus, 'bg-green-100 border-green-500': dragging && dropzoneStatus === 'hovered-over' }"
          draggable
        ...
        >
          <div class="space-y-1 text-center pointer-events-none">
            ...
            <div class="flex text-sm text-gray-600">
              <label for="file-upload" class="relative cursor-pointer rounded-md font-medium text-primary hover:text-primary focus-within:outline-none" :class="{ 'pointer-events-auto': !dragging }">
